...
![](screenshots/9.png)
After spinning up an 11G instance (We are using Oracle Database 11g Enterprise Edition Release 11.2.0.4.0 - 64bit Production, for this workshop, other versions like high performance may not work), you can click on the database and you will go to this screen. Click the DB Connection box. 
![](screenshots/10.png)
...
```
Good job, you have finished lab 100! [Click here to continue to lab 200.](https://github.com/zzhangjii/GoldenGate2ADB/blob/master/Lab200.md)
